export class ColorUtil {
   ...
   static colorWithLuminance(color, luminosity) {
    ...
    static oppositeTextColor (control, backgroundColor) {
        control.setTextColor(ColorUtil.getBrightness(backgroundColor) < 150 ? "#ffffff" : "#000");
    }
    ...
    static getAutoBrightnessTextColor(color) {
        var lumi = ColorUtil.getBrightness(color);
        var bright = 0;
        if (lumi <= 8) {
            bright = 1;
        ...
        var textColor = ColorUtil.colorWithLuminance(color, bright);
        return textColor;
    }
    ...
    static oppositeColor(colour) {
        ...
        return "#" + ColorUtil.decimalToHex(255 - ColorUtil.hexToDecimal(colour.substr(0, 2)))
            + ColorUtil.decimalToHex(255 - ColorUtil.hexToDecimal(colour.substr(2, 2)))
            + ColorUtil.decimalToHex(255 - ColorUtil.hexToDecimal(colour.substr(4, 2)));
    }
